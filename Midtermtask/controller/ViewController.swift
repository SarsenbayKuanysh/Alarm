...
class ViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    var alarm = [
        Alarm.init(timesString: "09:00", notesString: "Reading Books", isSwitched: true),
        Alarm.init(timesString: "10:00", notesString: "Footbal time", isSwitched: true),
        Alarm.init(timesString: "12:00", notesString: "Lunch", isSwitched: true),
        Alarm.init(timesString: "14:00", notesString: "Work", isSwitched: true),
        Alarm.init(timesString: "23:00", notesString: "Sleep", isSwitched: true),
    ]
